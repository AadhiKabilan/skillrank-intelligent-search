...
```
┌─────────────────┐    ┌──────────────────┐    ┌─────────────────┐
│   Data Pipeline │    │   Search API     │    │    Frontend     │
│   (ingest.py)   │    │   (app.py)       │    │ (index.html)    │
├─────────────────┤    ├──────────────────┤    ├─────────────────┤
│ • Load JSON     │───▶│ • FastAPI Server │◀───│ • Search Form   │
│ • Chunk Text    │    │ • FAISS Index    │    │ • Results View  │
...
│ • meta.json     │    │ • Cosine Sim     │    │ • Responsive    │
│ • Normalized    │    │ • Cross-Doc      │    │ • Real-time     │
